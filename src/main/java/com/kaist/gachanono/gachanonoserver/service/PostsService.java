...
public class PostsService {
    ...
    /* CREATE */
    @Transactional public Long save(PostsDto.Request dto, String nickname) {
    ...
    @Transactional public void update(Long id, PostsDto.Request dto) {
        Posts posts = postsRepository
            .findById(id)
    ...
    /* Views Counting */
    @Transactional public int updateView(Long id) {
        return postsRepository.updateView(id);
    }

    /* Goods Counting */
    @Transactional public int updateGood(Long id) {
    ...
    public Page<Posts> search(String keyword, Pageable pageable) {
        Page<Posts> postsList = postsRepository.findByTitleContainingOrContentContainingOrWriterContainingOrGamenameContaining(
            keyword,
            keyword,
            keyword,
            keyword,
